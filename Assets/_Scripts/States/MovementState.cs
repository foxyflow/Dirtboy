...
public class MovementState : State
{
    ...
    protected override void EnterState()
    {
        ...
        movementData.horizonalMovementDirection = 0;
    ...
    public override void StateUpdate()
    {
        if (TestFallTransition())
            return; //if true return fallstate and not run IdleState
        CalculateVelocity();
        SetPlayerVelocity();
    ...
    protected void CalculateVelocity()
    {
        ...
        movementData.currentVelocity = Vector3.right * movementData.horizonalMovementDirection
    ...
    protected void CalculateHorizontalDirection(MovementData movementData)
    {
        ...
        {
            movementData.horizonalMovementDirection = 1;
        }
    ...
    protected void CalculateSpeed(Vector2 movementVector, MovementData movementData)
    {
        ...
        {
            movementData.currentSpeed -= agent.agentData.deceleration * Time.deltaTime;
        }
